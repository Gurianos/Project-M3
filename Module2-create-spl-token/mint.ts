...
const endpoint = '<YOUR RPC PROVIDER ADDRESS hhtps>; //Replace with your RPC Endpoint
const solanaConnection = new Connection(endpoint);


const MINT_CONFIG = {
  //  numDecimal: 0 // When transfer, will be transfer to phantom wallet in NFT view :)
    numDecimals: 6,
    numberTokens: 5000
}
...
const MY_TOKEN_METADATA: UploadMetadataInput = {
  name: "GurianosToken",
    symbol: "GURIAS",
    description: "This is a GURI token!",
    image: "https://raw.githubusercontent.com/Gurianos/PubImgs/main/GURICOIN.png" //add public URL to image you'd like to use
}
...
const main = async() => {
    ...
    //New up-to date
    //const transactionId =  await solanaConnection.confirmTransaction(strategy: BlockheightBasedTransactionConfirmationStrategy, commitment?: Commitment,): Promise<RpcResponseAndContext<SignatureResult>>;
